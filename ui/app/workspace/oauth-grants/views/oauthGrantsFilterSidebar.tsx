...
function VirtualKeyFilterSection({ filters, onFiltersChange }: SidebarProps) {
	...
	return (
		<FilterSection title={t("Virtual Key")} defaultOpen={hasActive} onOpenChange={setOpened} testId="oauth-grants-filter-vk-toggle">
...
function UsersFilterSection({ filters, onFiltersChange }: SidebarProps) {
	...
	return (
		<FilterSection title={t("Users")} defaultOpen={hasActive} onOpenChange={setOpened} testId="oauth-grants-filter-users-toggle">
			<SearchableCheckboxList
				inputRef={searchInputRef}
