	...
	return (
		...
		>
			...
			<div className="flex flex-col gap-1">
				<h1 className="text-muted-foreground text-xl font-medium">{t("Virtual keys control access, budgets, and rate limits")}</h1>
				...
				<div className="mx-auto mt-6 flex flex-row flex-wrap items-center justify-center gap-2">
					<Button
						variant="outline"
						aria-label={t("Read more about virtual keys (opens in new tab)")}
					...
					<Button aria-label={t("Add your first virtual key")} onClick={onAddClick} disabled={!canCreate} data-testid="create-vk-btn">
						Add Virtual Key
					</Button>
				</div>
			</div>
